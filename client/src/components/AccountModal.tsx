  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Connect external platforms to power your dashboard.</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        {sleeperUsername && (
          <Link to="/leagues" className="text-sm text-blue-600 hover:underline inline-block">
